...
# main parameters
main_pars = {
    'outPath': 'output/',   # output root folder
    'numFiles': 250,     # number of output files to generate (for random modifications)
    'chain': True,
    'transf': ['pitch','gain']   # modifications to apply
    # 'transf': ['pitch']
}
...
pitch_pars = {
    ...
    'std': 150,        # standard deviation (cents) for random transposition (Gaussian distrib for now)
